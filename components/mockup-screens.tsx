// Компоненты Hi-Fi макетов для переиспользования в pdf4 и figma4

export function HomeScreen({ scale = 1 }: { scale?: number }) {
  return (
    <div className="bg-slate-50 rounded-3xl overflow-hidden shadow-xl border border-slate-200" style={{ width: 375 * scale, fontSize: `${scale * 100}%` }}>
      {/* Status Bar */}
...
export function LessonScreen({ scale = 1 }: { scale?: number }) {
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-slate-200" style={{ width: 375 * scale, fontSize: `${scale * 100}%` }}>
      {/* Status Bar */}
...
export function CatalogScreen({ scale = 1 }: { scale?: number }) {
  return (
    <div className="bg-slate-50 rounded-3xl overflow-hidden shadow-xl border border-slate-200" style={{ width: 375 * scale, fontSize: `${scale * 100}%` }}>
      {/* Status Bar */}
      <div className="bg-white px-6 py-2 flex items-center justify-between text-xs text-slate-600">
      ...
      <div className="bg-white px-5 py-4">
        ...
        <div className="relative mb-4">
          ...
          <input type="text" placeholder="Поиск курсов..." className="w-full pl-12 pr-4 py-3 bg-slate-100 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500" readOnly />
        </div>
...
export function CourseDetailsScreen({ scale = 1 }: { scale?: number }) {
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-slate-200" style={{ width: 375 * scale, fontSize: `${scale * 100}%` }}>
      {/* Hero */}
      ...
      <div className="px-5 py-4">
        ...
        <p className="text-sm text-slate-600 mb-4 leading-relaxed">
          ...
          работу с данными, циклы и функции.
        </p>
...
export function ProfileScreen({ scale = 1 }: { scale?: number }) {
  return (
    <div className="bg-slate-50 rounded-3xl overflow-hidden shadow-xl border border-slate-200" style={{ width: 375 * scale, fontSize: `${scale * 100}%` }}>
      {/* Status Bar */}
      <div className="bg-white px-6 py-2 flex items-center justify-between text-xs text-slate-600">
