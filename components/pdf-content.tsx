...
- Нет геймификации`,
    ...
    {
      number: 7,
      title: "Аналоги 3-4: Stepik и Sololearn",
...
+ Отличная геймификация, микроуроки, редактор кода
- Только программирование, много рекламы
...
Sololearn — отличный пример мобильного EdTech с геймификацией`,
    ...
    },
    {
      ...
      content: `Критерий          | Duo | Cour | Step | Solo  | LearnUp
------------------|-----|------|------|-------|--------
Микро-уроки       |  +  |  -   |  ±   |   +   |   +
Геймификация      |  +  |  -   |  -   |   +   |   +
Разнообразие тем  |  -  |  +   |  +   |   -   |   +
