...
const tabs = [
  ...
  {
    href: "/prototype/courses",
    label: "Курсы",
    match: "/prototype/courses",
    iconActive: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
const mainTabPaths = ["/prototype/main", "/prototype/courses", "/prototype/search", "/prototype/profile"]
      ...
      {tabs.map(({ href, label, match, iconActive, iconInactive }) => {
        ...
        return (
          <Link
            key={href}
            href={href}
            className={`flex flex-col items-center gap-0.5 transition-colors ${active ? "text-teal-500" : "text-slate-400"}`}
          >
